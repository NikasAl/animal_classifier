...
class VisionLLMClient:
    ...
    def chat_vision(self, system: str, user: str, image_path: str) -> tuple[str, float]:
    ...
    def identify(self, system: str, user: str, image_path: str) -> dict:
        raw, latency = self.chat_vision(system, user, image_path)
